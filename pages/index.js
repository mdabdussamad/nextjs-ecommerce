...
export default function Home() {
  return (
    <div>
      <Head>
        <title>Hygienic Store</title>
        <meta name="description" content="HygienicStore.com - Buy Here" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Hygienic Stuff with hygienicstore.com</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quaerat, eos labore rerum quod dignissimos, aperiam delectus adipisci tempore veritatis quasi odio id repellat asperiores. Alias ut labore nemo laboriosam possimus.</p>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Hygienic Stuff with hygienicstore.com</p>            
          </div>
