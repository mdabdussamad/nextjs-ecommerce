            ...
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">HYGIENIC STORE</h2>
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => { buyNow(slug, 1, product.price, product.title, size, color) }} className="flex ml-8 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded-full">Buy Now</button>
                            <button onClick={() => { addToCart(slug, 1, product.price, product.title, size, color) }} className="flex ml-4 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded-full">Add to Cart</button>
                        ...
                        <div className="pin mt-6 flex space-x-2 text-sm">
                            ...
                            <button onClick={checkServiceability} className="text-white bg-green-500 boder-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded-full">Check</button>
                        </div>
...
export async function getServerSideProps(context) {
    ...
    let colorSizeSlug = {}  //{red: {xl: {slug: 'ear-the-tshirt-XL'}}}
